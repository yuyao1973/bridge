...
def settings_from_payload(payload: dict[str, Any]) -> RuleSettings:
    ...
    rule_kwargs = {
        ...
        "negative_double_enabled": bool(values.get("negative_double_enabled", True)),
        "negative_double_min_hcp": int(values.get("negative_double_min_hcp", 6)),
        "inverted_minors_enabled": bool(values.get("inverted_minors_enabled", False)),
